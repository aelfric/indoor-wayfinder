...
export const objects: CubicleObject[] = [
    ...
    {"id": "501",color: "gray", "x": col292, "y": row316, entrance: "left"},
    {"id": "502",color: "gray", "x": col292, "y": row297, entrance: "left"},
    {"id": "503",color: "gray", "x": col292, "y": row238, entrance: "left"},
    {"id": "504",color: "gray", "x": col292, "y": row219, entrance: "left"},
    {"id": "505",color: "gray", "x": col292, "y": row160, entrance: "left"},
    {"id": "506",color: "gray", "x": col292, "y": row141, entrance: "left"},
    {"id": "507",color: "gray", "x": col292, "y": row121, entrance: "left"},
