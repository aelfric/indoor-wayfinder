...
export const objects: { x: number, y: number, id: string, entrance: "left"| "right" }[] = [
    ...
    {"id": "2501", "x": col945, "y": row316,entrance: "left"},
    {"id": "2502", "x": col945, "y": row297,entrance: "left"},
    {"id": "2503", "x": col945, "y": row277,entrance: "left"},
    {"id": "2504", "x": col945, "y": row258,entrance: "left"},
    {"id": "2505", "x": col945, "y": row238,entrance: "left"},
    {"id": "2506", "x": col945, "y": row219,entrance: "left"},
    {"id": "2507", "x": col945, "y": row180,entrance: "left"},
    {"id": "2508", "x": col945, "y": row160,entrance: "left"},
    {"id": "2509", "x": col945, "y": row141,entrance: "left"},
    {"id": "2510", "x": col945, "y": row121,entrance: "left"},
    {"id": "2511", "x": col945, "y": row102,entrance: "left"},
    {"id": "2512", "x": col945, "y": row082,entrance: "left"},
    {"id": "2513", "x": col945, "y": row063,entrance: "left"},
]
